const C='ahura-v77';const A=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./pdf.min.mjs','./pdf.worker.min.mjs','./f400.woff2','./f700.woff2','./n400.woff2','./n700.woff2'];
